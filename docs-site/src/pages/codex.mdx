...
Open the folder that contains `studio.yaml`. Codex should also see the downstream `AGENTS.md` installed by `vstd init`, which preserves the slide/companion contract and routes work through the canonical skills.
